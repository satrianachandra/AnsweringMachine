 ...
 * @author chandra
 */
public class FileStreamer extends Pipeline {
    
    
    public FileStreamer(String filePath, String ipAddress, int port){
        super();
        
        Element fileSrc = ElementFactory.make("filesrc", null);
        fileSrc.set("location", filePath);
        //"/home/chandra/NetBeansProjects/AnsweringMachine/lib/voicemailgreetings.mp3"
        ...
        System.out.println("playing file to "+port);
